...
class SystemsIntegrationOpsAdapter(SystemsIntegrationOps):
    """
    Adaptador para el agente SystemsIntegrationOps que utiliza los componentes optimizados.
    ...
    async def _classify_query_with_intent_analyzer(self, query: str) -> str:
        ...
        try:
            ...
            intent_to_query_type = {
                ...
                "data_flow": "data_pipeline_request"
            }
    ...
    async def _run_async_impl(self, input_text: str, user_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        ...
        logger.info(f"Ejecutando SystemsIntegrationOpsAdapter con input: {input_text[:50]}...")
        ...
        logger.info(f"SystemsIntegrationOpsAdapter completó la ejecución en {execution_time:.2f} segundos")
