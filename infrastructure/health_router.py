...
@health_router.get("/health/readiness", summary="Verificar si la aplicación está lista para recibir tráfico")
async def readiness():
    """
...
@health_router.get("/health/startup", summary="Verificar si la aplicación se ha inicializado correctamente")
async def startup():
    """
...
@health_router.get("/health/report", summary="Obtener informe completo del estado de la aplicación")
async def report():
    """
