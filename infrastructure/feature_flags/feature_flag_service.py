...
class FeatureFlagService:
    ...
    async def is_enabled(self, flag_name: str, user_id: Optional[str] = None, default: bool = False) -> bool:
        """
        ...
        """
        span = self.telemetry.start_span("feature_flags.is_enabled", {
            "flag_name": flag_name,
        ...
        try:
            ...
            if user_id:
                ...
                if user_override is not None:
                    self.telemetry.add_span_event(span, "user_override_applied", {
                        "flag_name": flag_name,
                        "user_id": user_id,
            ...
            self.telemetry.add_span_event(span, "rollout_check", {
                "flag_name": flag_name,
                "user_id": user_id,
    ...
    async def set_enabled(self, flag_name: str, enabled: bool, metadata: Optional[Dict[str, Any]] = None) -> bool:
        """
        ...
        """
        span = self.telemetry.start_span("feature_flags.set_enabled", {
            "flag_name": flag_name,
            "enabled": enabled
        })
        ...
        try:
            ...
            self.telemetry.add_span_event(span, "flag_updated", {
                "flag_name": flag_name,
                "enabled": enabled,
                "success": result
            })
    ...
    async def set_user_override(self, flag_name: str, user_id: str, enabled: bool) -> bool:
        """
        ...
        Returns:
            bool: True si la operación fue exitosa, False en caso contrario.
        """
        span = self.telemetry.start_span("feature_flags.set_user_override", {
            "flag_name": flag_name,
            "user_id": user_id,
            "enabled": enabled
        })
        ...
        try:
            ...
            self.telemetry.add_span_event(span, "user_override_set", {
                "flag_name": flag_name,
                "user_id": user_id,
                "enabled": enabled,
                "success": result
    ...
    async def set_rollout_percentage(self, flag_name: str, percentage: int) -> bool:
        ...
        Returns:
            bool: True si la operación fue exitosa, False en caso contrario.
        """
        span = self.telemetry.start_span("feature_flags.set_rollout_percentage", {
            "flag_name": flag_name,
        ...
        try:
            ...
            self.telemetry.add_span_event(span, "rollout_percentage_set", {
                "flag_name": flag_name,
                "percentage": percentage,
                "success": result
            })
    ...
    async def create_staged_rollout(self, flag_name: str, stages: List[Dict[str, Any]]) -> bool:
        """
        ...
        Returns:
            bool: True si la operación fue exitosa, False en caso contrario.
        """
        span = self.telemetry.start_span("feature_flags.create_staged_rollout", {
            "flag_name": flag_name,
        ...
        try:
            ...
            for i, stage in enumerate(stages):
                if "percentage" not in stage or "duration_hours" not in stage:
                    raise ValueError(f"La etapa {i} debe tener percentage y duration_hours")
            ...
            self.telemetry.add_span_event(span, "staged_rollout_created", {
                "flag_name": flag_name,
                "stages_count": len(stages),
