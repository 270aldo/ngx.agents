...
class RedisFeatureFlagStore:
    ...
    async def set_flag(self, flag_name: str, enabled: bool, metadata: Optional[Dict[str, Any]] = None) -> bool:
        """
        ...
        """
        span = self.telemetry.start_span("feature_flags.set_flag", {
            "flag_name": flag_name,
            "enabled": enabled
        })
        ...
        try:
            ...
            self.telemetry.add_span_event(span, "feature_flag_updated", {
                "flag_name": flag_name,
                "enabled": enabled
            })
    ...
    async def get_flag(self, flag_name: str, default: bool = False) -> Tuple[bool, Dict[str, Any]]:
        """
        ...
        """
        span = self.telemetry.start_span("feature_flags.get_flag", {
            "flag_name": flag_name
        })
    ...
    async def get_user_override(self, flag_name: str, user_id: str) -> Optional[bool]:
        ...
        """
        span = self.telemetry.start_span("feature_flags.get_user_override", {
            "flag_name": flag_name,
            "user_id": user_id
        })
    ...
    async def set_rollout_percentage(self, flag_name: str, percentage: int) -> bool:
        ...
        try:
            ...
            # Registrar evento de telemetría
            self.telemetry.add_span_event(span, "rollout_percentage_updated", {
                "flag_name": flag_name,
                "percentage": percentage
            })
    ...
    async def get_rollout_percentage(self, flag_name: str) -> Optional[int]:
        ...
        """
        span = self.telemetry.start_span("feature_flags.get_rollout_percentage", {
            "flag_name": flag_name
        })
