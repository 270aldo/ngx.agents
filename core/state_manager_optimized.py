...
class LRUCache:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "usage_percentage": len(self.cache) / self.capacity * 100 if self.capacity > 0 else 0
        }
...
class StateManager:
    ...
    async def set_conversation_state(self, 
                                  conversation_id: str, 
    ...
    async def set_conversation_metadata(self, 
                                     conversation_id: str, 
    ...
    async def set_temp_context(self, 
                            key: str, 
                            value: Any, 
