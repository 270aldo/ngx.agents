"""
Analizador de intenciones para NGX Agents.

Este módulo proporciona clases y funciones para analizar las intenciones
de los usuarios y determinar qué agentes deben responder a sus consultas.
"""
...
class Intent:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Intent":
        ...
        if "created_at" in data:
            intent.created_at = data["created_at"]
...
# Clase principal para mantener compatibilidad con las pruebas
class IntentAnalyzer:
    """
    Analizador de intenciones.

    Esta clase proporciona métodos para analizar las intenciones de los usuarios
    y determinar qué agentes deben responder a sus consultas.
    """
    ...
    async def initialize(self) -> None:
        """Inicializa recursos necesarios para el analizador."""
        logger.info("Analizador de intenciones inicializado")
    ...
    async def analyze_intent(
        ...
        """
        # Implementación básica para compatibilidad con pruebas
        self.stats["total_queries"] += 1

        # Crear una intención genérica
        intent = Intent(
    ...
    async def get_stats(self) -> Dict[str, Any]:
        """
        Obtiene estadísticas de uso del analizador.
...
# Instancia global para compatibilidad con las pruebas
