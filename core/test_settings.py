...
class MockTestSettings(Settings):
    ...
    supabase_anon_key: str = Field(default="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test", json_schema_extra={"env": "SUPABASE_ANON_KEY"})
    jwt_secret: str = Field(default="test_secret_key", json_schema_extra={"env": "JWT_SECRET"})
