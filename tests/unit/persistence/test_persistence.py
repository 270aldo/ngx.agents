...
class TestConversationPersistence:
    ...
    def test_get_conversation_history_with_pagination(self, supabase_client):
        ...
        page1 = supabase_client.get_conversation_history(TEST_USER_ID, limit=4, offset=0)
        assert len(page1) == 4
        ...
        page2 = supabase_client.get_conversation_history(TEST_USER_ID, limit=4, offset=4)
        assert len(page2) == 4
    ...
    def test_get_conversation_history_for_different_users(self, supabase_client):
        ...
        supabase_client.log_conversation_message(TEST_USER_ID, "user", "Mensaje usuario 1")
        supabase_client.log_conversation_message(other_user_id, "user", "Mensaje usuario 2")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (False, 2),  # En modo real, se llama a la API de Supabase dos veces (select e insert)
    ],
)
