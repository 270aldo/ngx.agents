...
from infrastructure.adapters.recovery_corrective_adapter import recovery_corrective_adapter
...
async def test_initialize():
    ...
    with patch('infrastructure.adapters.recovery_corrective_adapter.intent_analyzer_adapter') as mock_intent_analyzer, \
         patch('infrastructure.adapters.recovery_corrective_adapter.state_manager_adapter') as mock_state_manager, \
         patch('infrastructure.adapters.recovery_corrective_adapter.a2a_adapter') as mock_a2a_adapter:
...
async def test_process_query():
    ...
    # Mockear las dependencias
    with patch('infrastructure.adapters.recovery_corrective_adapter.intent_analyzer_adapter') as mock_intent_analyzer, \
         patch('infrastructure.adapters.recovery_corrective_adapter.telemetry_adapter') as mock_telemetry, \
         patch('infrastructure.adapters.recovery_corrective_adapter.vertex_ai_client') as mock_vertex_ai:
        ...
        mock_vertex_ai.generate_text.return_value = "Análisis de lesión generado por el modelo"
...
async def test_determine_query_type():
    ...
    test_cases = [
        ...
        ([MagicMock(intent_type="rehabilitation_protocol")], "", "rehabilitation_protocol"),
...
async def test_a2a_integration():
    ...
    with patch('infrastructure.adapters.a2a_adapter.a2a_server') as mock_a2a_server, \
        ...
        callback = a2a_adapter.registered_agents[recovery_corrective_adapter.agent_id]["message_callback"]
