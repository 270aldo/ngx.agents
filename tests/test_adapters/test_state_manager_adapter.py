...
async def test_add_message_to_conversation():
    ...
    updated_context = await state_manager_adapter.add_message_to_conversation(conversation_id, message)
...
async def test_add_intent_to_conversation():
    ...
    updated_context = await state_manager_adapter.add_intent_to_conversation(conversation_id, intent)
