...
class TestPrecisionNutritionArchitect(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('agents.precision_nutrition_architect.agent.GeminiClient', return_value=self.gemini_client_mock):
            with patch('agents.precision_nutrition_architect.agent.ProgramClassificationService', return_value=self.program_classification_service_mock):
    ...
    def test_generate_supplement_recommendation(self):
        ...
        # Ejecutar el método
        result = asyncio.run(self.agent._generate_supplement_recommendation(
    ...
    def test_skill_recommend_supplements_uses_program_classification(self):
        ...
        call_args, call_kwargs = self.agent._generate_supplement_recommendation.call_args
