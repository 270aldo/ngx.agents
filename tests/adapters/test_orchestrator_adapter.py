...
def mock_intent_analyzer_adapter():
    ...
    with patch('infrastructure.adapters.orchestrator_adapter.intent_analyzer_adapter') as mock:
...
def mock_state_manager_adapter():
    ...
    with patch('infrastructure.adapters.orchestrator_adapter.state_manager_adapter') as mock:
