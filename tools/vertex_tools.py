...
from prototipo.clients.vertex_client import vertex_client
...
class VertexGenerateInput(BaseModel):
    ...
    prompt: Union[str, List[Dict[str, Any]]] = Field(..., description="Texto o lista de partes")
...
class VertexGenerateOutput(BaseModel):
    ...
    candidates: List[Dict[str, Any]] = Field(default_factory=list, description="Candidatos alternativos")
...
class VertexClassifyOutput(BaseModel):
    ...
    classifications: Dict[str, float] = Field(..., description="Puntuaciones por categoría")
