...
class RunbookExecutor:
    ...
    def __init__(self, runbooks_dir: Optional[str] = None, telemetry_adapter=None, pagerduty_client=None):
        """
        ...
        """
        self.runbooks_dir = runbooks_dir or os.path.join(os.path.dirname(__file__), "templates")
    ...
    async def get_runbook(self, runbook_id: str) -> Optional[Dict[str, Any]]:
        ...
        """
        span = self.telemetry.start_span("runbooks.get_runbook", {
    ...
    async def execute_runbook(self, runbook_id: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        Ejecuta un runbook.
        ...
        """
        span = self.telemetry.start_span("runbooks.execute_runbook", {
            "runbook_id": runbook_id
        })
        ...
        try:
            ...
            self.telemetry.add_span_event(span, "runbook_execution_started", {
                "runbook_id": runbook_id,
            ...
            # Ejecutar pasos
            result = await self._execute_steps(runbook.get("steps", []), ctx, execution_id)
            ...
            # Registrar evento de telemetría
            self.telemetry.add_span_event(span, "runbook_execution_completed", {
                "runbook_id": runbook_id,
                "execution_id": execution_id,
                "success": True
            })
            ...
            # Registrar evento de telemetría
            self.telemetry.add_span_event(span, "runbook_execution_failed", {
                "runbook_id": runbook_id,
                "execution_id": execution_id,
                "error": str(e)
            })
    ...
    async def _execute_steps(self, steps: List[Dict[str, Any]], context: Dict[str, Any], execution_id: str) -> Dict[str, Any]:
        """
        ...
        for i, step in enumerate(steps):
            ...
            span = self.telemetry.start_span("runbooks.execute_step", {
            ...
            try:
                ...
                if "condition" in step and not self._evaluate_condition(step["condition"], context):
                    ...
                    step_result["result"] = {"skipped": True, "reason": "condition_not_met"}
                    
                    self.telemetry.add_span_event(span, "step_skipped", {
                        "step_id": step_id,
                ...
                if "command" in step:
                    ...
                    if command_name in self.commands:
                        # Ejecutar comando
                        command_result = await self.commands[command_name](command_args, context)
                ...
                if "exit_condition" in step and self._evaluate_condition(step["exit_condition"], context):
                    step_result["status"] = "completed"
                    step_result["end_time"] = datetime.now().isoformat()
                    
                    self.telemetry.add_span_event(span, "step_completed_with_exit", {
                        "step_id": step_id
                    })
                ...
                self.telemetry.add_span_event(span, "step_completed", {
                    "step_id": step_id
                })
    ...
    def _evaluate_condition(self, condition: Dict[str, Any], context: Dict[str, Any]) -> bool:
        ...
        if "var" in condition:
            ...
            return all(self._evaluate_condition(cond, context) for cond in condition["and"])
        elif "or" in condition:
            # Evaluar OR de condiciones
            return any(self._evaluate_condition(cond, context) for cond in condition["or"])
    ...
    async def _notify_execution_end(self, runbook: Dict[str, Any], execution_id: str, success: bool):
        """
    ...
    async def _notify_execution_error(self, runbook: Dict[str, Any], execution_id: str, error: str):
        """
    ...
    async def _cmd_check_metric(self, args: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _cmd_check_health(self, args: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _cmd_restart_service(self, args: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _cmd_scale_service(self, args: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _cmd_notify(self, args: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _cmd_wait(self, args: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _cmd_execute_query(self, args: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _cmd_check_logs(self, args: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _cmd_run_command(self, args: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _cmd_toggle_feature_flag(self, args: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
