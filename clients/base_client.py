...
def retry_with_backoff(max_retries: Optional[int] = None, 
    ...
    def decorator(func: Callable[..., T]) -> Callable[..., T]:
        ...
        async def wrapper_async(*args: Any, **kwargs: Any) -> T:
            ...
            for attempt in range(1, _max_retries + 2):  # +2 porque el primer intento no es reintento
                try:
                    ...
                    if attempt > _max_retries:
                        logger.error(f"Agotados todos los intentos ({_max_retries+1}) para {func.__name__}")
