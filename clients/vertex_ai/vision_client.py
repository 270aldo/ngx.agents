...
class VertexAIVisionClient:
    ...
    def __init__(self, model: str = "gemini-1.5-pro-vision", telemetry: Optional[Telemetry] = None):
        ...
        try:
            ...
            logger.info(f"Inicializando Vertex AI para VertexAIVisionClient con Proyecto: {gcp_project_id}, Región: {gcp_region}")
            aiplatform.init(project=gcp_project_id, location=gcp_region)
            self.vertex_ai_initialized = True
            logger.info("Vertex AI inicializado correctamente para VertexAIVisionClient")
        except Exception as e:
            logger.error(f"Error al inicializar Vertex AI para VertexAIVisionClient: {e}", exc_info=True)
    
    async def analyze_image(self, image_data: Union[str, Dict[str, Any]], 
        ...
        try:
            ...
            if self.telemetry and span:
                ...
                # Registrar métricas
                self.telemetry.record_metric("vertex_ai_vision_analyze_image_duration", duration)
            ...
            if self.telemetry and span:
                ...
                self.telemetry.record_metric("vertex_ai_vision_analyze_image_error_count", 1)
    ...
    async def extract_text(self, image_data: Union[str, Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if self.vertex_ai_initialized:
                ...
                # Simulación para desarrollo/pruebas
                logger.warning("Vertex AI no inicializado. Usando extracción de texto simulada.")
                result = {
            ...
            if self.telemetry and span:
                ...
                # Registrar métricas
                self.telemetry.record_metric("vertex_ai_vision_extract_text_duration", duration)
            ...
            if self.telemetry and span:
                ...
                # Registrar métricas de error
                self.telemetry.record_metric("vertex_ai_vision_extract_text_error_count", 1)
    ...
    async def detect_objects(self, image_data: Union[str, Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if self.vertex_ai_initialized:
                ...
                try:
                    ...
                    logger.warning(f"No se pudo extraer JSON de la respuesta: {json_error}")
                    # Mantener la respuesta de texto original
            else:
                # Simulación para desarrollo/pruebas
                logger.warning("Vertex AI no inicializado. Usando detección de objetos simulada.")
                result = {
            ...
            if self.telemetry and span:
                ...
                # Registrar métricas
                self.telemetry.record_metric("vertex_ai_vision_detect_objects_duration", duration)
            ...
            if self.telemetry and span:
                ...
                # Registrar métricas de error
                self.telemetry.record_metric("vertex_ai_vision_detect_objects_error_count", 1)
