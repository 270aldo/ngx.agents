...
class PerplexityClient(BaseClient):
    ...
    async def research(
        ...
        prompt += ". Estructura la respuesta con secciones claras y cita todas las fuentes."
        
        payload = {
            "model": model,
            "messages": [
                {"role": "system", "content": "Eres un asistente de investigación que proporciona información detallada y bien estructurada con fuentes verificables."},
    ...
    async def fact_check(
        ...
        payload = {
            "model": model,
            "messages": [
                {"role": "system", "content": "Eres un verificador de hechos preciso y objetivo que siempre proporciona fuentes verificables."},
                {"role": "user", "content": prompt}
            ]
        }
