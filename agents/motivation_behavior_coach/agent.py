...
from agents.motivation_behavior_coach.schemas import (
    HabitFormationInput,
    HabitFormationOutput,
    GoalSettingInput,
    GoalSettingOutput,
    MotivationStrategiesInput,
    MotivationStrategiesOutput,
    BehaviorChangeInput,
    BehaviorChangeOutput,
    ObstacleManagementInput,
    ObstacleManagementOutput,
    HabitPlanArtifact,
    GoalPlanArtifact,
    MotivationStrategiesArtifact,
    BehaviorChangePlanArtifact,
...
class MotivationBehaviorCoach(ADKAgent):
    ...
    AGENT_DESCRIPTION = (
        "Especialista en motivación, formación de hábitos y cambio de comportamiento"
    )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.voice_emotion_skill = VoiceEmotionAnalysisSkill()
        ...
        self.skills = [
            ...
            Skill(
                name="voice_motivation",
                description="Proporciona feedback motivacional personalizado mediante síntesis de voz",
                handler=self._skill_voice_motivation,
            ),
            Skill(
                name="emotional_check_in",
                description="Analiza el estado emocional del usuario a través de su voz para ajustar el apoyo motivacional",
                handler=self._skill_emotional_check_in,
            ),
        ]
        ...
        try:
            ...
            logger.info(
                "AI Platform (Vertex AI SDK) inicializado correctamente para MotivationBehaviorCoach."
            )
        except Exception as e:
            logger.error(
                f"Error al inicializar AI Platform para MotivationBehaviorCoach: {e}",
                exc_info=True,
            )
    ...
    async def _skill_habit_formation(
        self, input_data: HabitFormationInput
    ) -> HabitFormationOutput:
        """
        ...
        """
        logger.info(
            f"Ejecutando habilidad: _skill_habit_formation con input: {input_data.user_input[:30]}..."
        )

        try:
            # Generar el plan de hábitos
            habit_data = await self._generate_habit_plan(
            ...
            habit_plan = HabitPlan(
                ...
                implementation_intention=habit_data.get(
            ...
            return HabitFormationOutput(
                ...
                obstacles=habit_data.get(
                    "obstacles",
                    [{"obstacle": "Falta de tiempo", "strategy": "Priorizar"}],
                ),
                consistency_strategies=habit_data.get(
    ...
    async def _generate_habit_plan(
                        ...
                        "obstacles": [
                            {
                                ...
                                "strategy": "Reducir el hábito a su versión mínima viable",
                            },
                            {
                                "obstacle": "Olvido",
                                "strategy": "Establecer recordatorios visuales en el entorno",
                            },
                            {
                                "obstacle": "Pérdida de motivación",
                                "strategy": "Conectar el hábito con valores personales profundos",
                            },
                        ],
    ...
    async def _skill_goal_setting(
        self, input_data: GoalSettingInput
    ) -> GoalSettingOutput:
        """
        ...
        """
        logger.info(
            f"Ejecutando habilidad: _skill_goal_setting con input: {input_data.user_input[:30]}..."
        )
        ...
        try:
                ...
                if isinstance(milestone_data, dict):
                    milestones.append(
                        Milestone(
                            ...
                            target_date=milestone_data.get(
            ...
            timeline = Timeline(
                ...
                key_dates=timeline_data.get(
                    "key_dates", ["Fecha clave 1", "Fecha clave 2"]
                ),
            )
            ...
            tracking = TrackingSystem(
                ...
                review_points=tracking_data.get(
                    "review_points", ["Revisión semanal", "Revisión mensual"]
                ),
            )
            ...
            return GoalSettingOutput(goal_plan=goal_plan)
        except Exception as e:
            ...
            return GoalSettingOutput(
                goal_plan=GoalPlan(
                    ...
                    timeline=Timeline(
                        start_date="Hoy", end_date="No definido", key_dates=[]
                    ),
                    ...
                    tracking=TrackingSystem(
                        frequency="N/A", method="N/A", review_points=[]
                    ),
                )
            )

    async def _generate_goal_plan(
        self, user_input: str, user_profile: Optional[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
                ...
                try:
                    ...
                    response = {
                        ...
                        "timeline": {
                            "start_date": "Inicio",
                            "end_date": "Fin",
                            "key_dates": ["Fecha clave"],
                        },
                        "resources": ["Recurso necesario"],
                        "obstacles": [
                            {"description": "Obstáculo", "strategy": "Estrategia"}
                        ],
                        "tracking": {
                            "frequency": "Semanal",
                            "method": "Método",
                            "review_points": ["Revisión"],
                        },
                    }
    ...
    async def _skill_motivation_strategies(
        self, input_data: MotivationStrategiesInput
    ) -> MotivationStrategiesOutput:
        """
        ...
        """
        logger.info(
            f"Ejecutando habilidad: _skill_motivation_strategies con input: {input_data.user_input[:30]}..."
        )
        ...
        try:
                ...
                if isinstance(strategy_data, dict):
                    strategies.append(
                        MotivationStrategy(
                            ...
                            implementation=strategy_data.get(
                                "implementation", "Pasos para implementar"
                            ),
                            science_behind=strategy_data.get(
                                "science_behind",
                                "Respaldado por investigaciones en psicología positiva",
                            ),
                            example=strategy_data.get(
                                "example",
                                f"Ejemplo de aplicación para programa {program_type}",
                            ),
                        )
                    )
            ...
            long_term_approach = motivation_data.get(
                "long_term_approach",
                "Enfoque a largo plazo para mantener la motivación",
            )
            ...
            return MotivationStrategiesOutput(
                ...
                daily_practices=motivation_data.get(
                    "daily_practices", ["Práctica diaria recomendada"]
                ),
            ...
            logger.error(
                f"Error en skill '_skill_motivation_strategies': {e}", exc_info=True
            )
    ...
    async def _generate_motivation_strategies(
        self, user_input: str, user_profile: Optional[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.info(
                f"Tipo de programa determinado para estrategias de motivación: {program_type}"
            )
            ...
            if program_def:
                ...
                if program_type == "PRIME":
                    ...
                    program_context += (
                        "- Técnicas para superar mesetas de rendimiento\n"
                    )
                    program_context += (
                        "- Motivación basada en logros y mejoras medibles\n"
                    )
                elif program_type == "LONGEVITY":
                    program_context += (
                    ...
                    program_context += (
                        "- Motivación basada en calidad de vida y bienestar\n"
                    )
        except Exception as e:
            logger.warning(
                f"No se pudo determinar el tipo de programa: {e}. Usando estrategias generales."
            )
    ...
    async def _skill_behavior_change(
        self, input_data: BehaviorChangeInput
    ) -> BehaviorChangeOutput:
        """
        ...
        """
        logger.info(
            f"Ejecutando habilidad: _skill_behavior_change con input: {input_data.user_input[:30]}..."
        )
        ...
        try:
                ...
                if isinstance(stage_data, dict):
                    stages.append(
                        BehaviorChangeStage(
                            ...
                            description=stage_data.get(
                                "description", "Descripción de la etapa"
                            ),
                            strategies=stage_data.get(
                                "strategies", ["Estrategia recomendada"]
                            ),
                            duration=stage_data.get("duration", "2-4 semanas"),
                            success_indicators=stage_data.get(
                                "success_indicators", ["Indicador de éxito"]
                            ),
                        )
                    )
            ...
            behavior_plan = BehaviorChangePlan(
                target_behavior=behavior_data.get(
                    "target_behavior", "Comportamiento objetivo"
                ),
                current_state=behavior_data.get(
                    "current_state", "Estado actual del comportamiento"
                ),
                desired_state=behavior_data.get(
                    "desired_state", "Estado deseado del comportamiento"
                ),
                stages=stages,
                psychological_techniques=behavior_data.get(
                    "psychological_techniques", ["Técnica psicológica recomendada"]
                ),
                environmental_adjustments=behavior_data.get(
                    "environmental_adjustments", ["Ajuste ambiental recomendado"]
                ),
                support_systems=behavior_data.get(
                    "support_systems", ["Sistema de apoyo recomendado"]
                ),
            )
            ...
            return BehaviorChangeOutput(
                ...
                success_probability_factors=behavior_data.get(
                    "success_probability_factors",
                    ["Factor que afecta la probabilidad de éxito"],
                ),
            )
    ...
    async def _generate_behavior_change_plan(
        self, user_input: str, user_profile: Optional[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
                    ...
                    response = {
                        ...
                        "stages": [
                            ...
                            },
                            {
                                ...
                                "success_indicators": [
                                    "Consistencia en nuevos comportamientos",
                                    "Reducción de comportamientos antiguos",
                                ],
                            },
                            {
    ...
    async def _skill_obstacle_management(
        self, input_data: ObstacleManagementInput
    ) -> ObstacleManagementOutput:
        """
        ...
        """
        logger.info(
            f"Ejecutando habilidad: _skill_obstacle_management con input: {input_data.user_input[:30]}..."
        )
        ...
        try:
            ...
            obstacle_analysis = ObstacleAnalysis(
                ...
                frequency=obstacle_data.get(
                    "frequency", "Frecuencia con la que aparece"
                ),
                triggers=obstacle_data.get(
                    "triggers", ["Desencadenante del obstáculo"]
                ),
                past_attempts=obstacle_data.get(
            ...
            primary_solution = ObstacleSolution(
                ...
                implementation=primary_solution_data.get(
                    "implementation", "Pasos para implementar"
                ),
                expected_outcome=primary_solution_data.get(
                    "expected_outcome", "Resultado esperado"
                ),
                alternative_approaches=primary_solution_data.get(
                    "alternative_approaches", ["Enfoque alternativo"]
                ),
                resources_needed=primary_solution_data.get(
            ...
            for solution_data in obstacle_data.get("alternative_solutions", []):
                if isinstance(solution_data, dict):
                    alternative_solutions.append(
                        ObstacleSolution(
                            strategy=solution_data.get(
                                "strategy", "Estrategia alternativa"
                            ),
                            implementation=solution_data.get(
                                "implementation", "Pasos para implementar"
                            ),
                            expected_outcome=solution_data.get(
                                "expected_outcome", "Resultado esperado"
                            ),
                            alternative_approaches=solution_data.get(
                                "alternative_approaches", ["Enfoque alternativo"]
                            ),
                            resources_needed=solution_data.get(
                                "resources_needed", ["Recurso necesario"]
                            ),
                        )
                    )
            ...
            return ObstacleManagementOutput(
                ...
                prevention_strategies=obstacle_data.get(
                    "prevention_strategies", ["Estrategia de prevención"]
                ),
                mindset_adjustments=obstacle_data.get(
            ...
            logger.error(
                f"Error en skill '_skill_obstacle_management': {e}", exc_info=True
            )
            # En caso de error, devolver estrategias básicas
            return ObstacleManagementOutput(
                obstacle_analysis=ObstacleAnalysis(
    ...
    async def _generate_obstacle_management_plan(
        self, user_input: str, user_profile: Optional[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
                    ...
                    response = {
                        ...
                        "alternative_solutions": [
                            ...
                            },
                            {
                                ...
                                "resources_needed": [
                                    "Recursos para esta segunda alternativa"
                                ],
                            },
                        ],
    ...
    async def _skill_voice_motivation(self, **kwargs) -> Dict[str, Any]:
        """
        Genera feedback motivacional personalizado mediante síntesis de voz.

        Args:
            **kwargs: Parámetros de entrada que pueden incluir:
                - message_type: Tipo de mensaje motivacional (encouragement, milestone, challenge)
                - context: Contexto actual del usuario
                - achievement: Logro específico a celebrar (opcional)
                - challenge: Desafío actual del usuario (opcional)
                - user_name: Nombre del usuario para personalización
                - voice_preferences: Preferencias de voz del usuario

        Returns:
            Dict[str, Any]: Audio motivacional y metadata
        """
        try:
            message_type = kwargs.get("message_type", "encouragement")
            ...
            # Generar mensaje motivacional personalizado basado en el contexto
            if message_type == "milestone" and achievement:
                base_message = f"¡Felicitaciones por {achievement}! Este es un logro increíble que demuestra tu compromiso y dedicación."
            elif message_type == "challenge" and challenge:
                base_message = f"Entiendo que {challenge} puede ser difícil. Recuerda que cada pequeño paso cuenta y ya has demostrado que puedes superar obstáculos."
            else:
                # Mensaje de aliento general
                motivational_messages = [
                    "Cada día es una nueva oportunidad para acercarte a tus metas. ¡Sigue adelante!",
                    "Tu constancia está dando frutos. Mantén ese impulso positivo.",
                    "Los grandes cambios comienzan con pequeñas acciones. Estás en el camino correcto.",
                    "Tu dedicación es inspiradora. Continúa creyendo en ti mismo.",
            ...
            if user_name:
                base_message = f"{user_name}, {base_message.lower()}"

            # Usar la skill de audio feedback
            feedback_result = await self.audio_feedback_skill.execute(
                {
                    "feedback_type": "encouragement",
                    "parameters": {"custom_message": base_message},
                    "voice_settings": voice_preferences,
                    "user_profile": {"name": user_name} if user_name else {},
                }
            )
            ...
            if feedback_result.get("status") != "success":
                return {
                    ...
                    "error": feedback_result.get(
                        "error", "Error generando audio motivacional"
                    ),
                }
            ...
            return {
                ...
                "duration": feedback_result.get("duration_estimate", 5.0),
                "voice_used": feedback_result.get("voice_used"),
                "metadata": {
                    "personalized": bool(user_name),
                    "context_aware": bool(achievement or challenge),
                },
            }

        except Exception as e:
            logger.error(f"Error en skill de motivación por voz: {e}")
            return {"status": "error", "error": str(e)}

    async def _skill_emotional_check_in(self, **kwargs) -> Dict[str, Any]:
        """
        Analiza el estado emocional del usuario a través de su voz.

        Args:
            **kwargs: Parámetros de entrada que incluyen:
                - audio_data: Datos del audio (base64, URL o path)
                - previous_emotional_state: Estado emocional previo
                - current_goals: Metas actuales del usuario
                - recent_achievements: Logros recientes

        Returns:
            Dict[str, Any]: Análisis emocional y recomendaciones motivacionales
        """
        try:
            ...
            if not audio_data:
                return {
                    "status": "error",
                    "error": "No se proporcionaron datos de audio para el análisis",
                }

            previous_state = kwargs.get("previous_emotional_state", {})
            current_goals = kwargs.get("current_goals", [])
            recent_achievements = kwargs.get("recent_achievements", [])

            # Usar la skill de análisis emocional
            emotion_result = await self.voice_emotion_skill.execute(
                {
            ...
            if emotion_result.get("status") != "success":
                return {
                    "status": "error",
                    "error": emotion_result.get("error", "Error analizando emociones"),
                }

            # Extraer información del análisis
            emotional_state = emotion_result.get("emotional_state", "neutral")
            confidence = emotion_result.get("confidence", 0.0)
            emotions = emotion_result.get("emotions", {})
            physical_indicators = emotion_result.get("physical_indicators", {})
            transcription = emotion_result.get("transcription", "")

            # Generar recomendaciones motivacionales basadas en el estado emocional
            motivational_recommendations = []

            if (
                emotional_state == "fatigued"
                or physical_indicators.get("fatigue_level", 0) > 0.6
            ):
                motivational_recommendations.extend(
                    [
                        {
                            "type": "rest_and_recovery",
                            "message": "Tu bienestar es prioritario. Considera tomar un descanso adecuado.",
                            "action": "schedule_rest_day",
                            "priority": "high",
                        },
                        {
                            "type": "motivation_adjustment",
                            "message": "Ajustemos tus metas temporalmente para mantener el progreso sin agotarte.",
                            "action": "reduce_goal_intensity",
                            "priority": "medium",
                        },
                    ]
                )
                ...
                or physical_indicators.get("stress_level", 0) > 0.6
            ):
                motivational_recommendations.extend(
                    [
                        {
                            "type": "reframe_perspective",
                            "message": "Los desafíos son oportunidades de crecimiento. Revisemos tu enfoque.",
                            "action": "review_approach",
                            "priority": "high",
                        },
                        {
                            "type": "celebrate_progress",
                            "message": "Recordemos tus logros recientes para recuperar la perspectiva.",
            ...
            elif emotional_state == "motivated" or emotions.get("alegría", 0) > 0.6:
                motivational_recommendations.extend(
                    [
                        {
                            "type": "capitalize_momentum",
                            "message": "¡Tu energía es contagiosa! Es el momento perfecto para avanzar.",
                            "action": "suggest_stretch_goal",
                            "priority": "medium",
                        },
                        {
                            "type": "maintain_consistency",
                            "message": "Mantén este impulso positivo con acciones consistentes.",
            ...
            # Análisis de cambios en el estado emocional
            emotional_trend = "stable"
            if previous_state:
                prev_energy = previous_state.get("physical_indicators", {}).get(
                    "energy_level", 0.5
                )
                curr_energy = physical_indicators.get("energy_level", 0.5)

                if curr_energy - prev_energy > 0.2:
                    emotional_trend = "improving"
                elif prev_energy - curr_energy > 0.2:
                    emotional_trend = "declining"

            # Generar insights motivacionales
            motivational_insights = []

            # Analizar el contenido de la transcripción para insights adicionales
            if transcription:
                words_lower = transcription.lower()

                if any(
                    word in words_lower
                    for word in ["puedo", "logré", "conseguí", "bien"]
                ):
                    motivational_insights.append(
                        "Tu lenguaje refleja confianza y logro. ¡Sigue así!"
                    )

                if any(
                    word in words_lower for word in ["difícil", "cuesta", "no puedo"]
                ):
                    motivational_insights.append(
                        "Reconoces los desafíos, lo cual es el primer paso para superarlos."
                    )

                if any(word in words_lower for word in ["mañana", "después", "luego"]):
                    motivational_insights.append(
                        "Considera actuar hoy. El mejor momento es ahora."
                    )
            ...
            return {
                ...
                "motivational_response": {
                    "recommendations": motivational_recommendations,
                    "insights": motivational_insights,
                    "suggested_actions": self._generate_motivational_actions(
                        emotional_state, current_goals, recent_achievements
                    ),
                },
                ...
                "needs_intervention": emotion_result.get("needs_intervention", False),
            }

        except Exception as e:
            logger.error(f"Error en check-in emocional: {e}")
            return {"status": "error", "error": str(e)}

    def _generate_motivational_actions(
        self, emotional_state: str, goals: list, achievements: list
    ) -> list:
        """
        Genera acciones motivacionales específicas basadas en el estado emocional.

        Args:
            emotional_state: Estado emocional actual
            goals: Lista de metas actuales
            achievements: Lista de logros recientes

        Returns:
            Lista de acciones motivacionales sugeridas
        """
        actions = []

        if emotional_state in ["fatigued", "frustrated"]:
            actions.extend(
                [
                    {
                        "action": "mini_celebration",
                        "description": "Celebra un pequeño logro de hoy",
                        "duration": "5 minutos",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "description": "Ajusta una meta para hacerla más alcanzable esta semana",
                        "duration": "15 minutos",
                    },
                ]
            )
            ...
            actions.extend(
                [
                    {
                        "action": "momentum_task",
                        "description": "Completa una tarea importante mientras tienes energía",
                        "duration": "25 minutos",
                    },
                    {
                        "action": "share_progress",
                        "description": "Comparte tu progreso con alguien que te apoye",
                        "duration": "10 minutos",
                    },
                    {
                        "action": "plan_next_milestone",
                        "description": "Define tu próximo hito importante",
                        "duration": "20 minutos",
                    },
                ]
            )

        else:  # neutral o in_pain
            actions.extend(
                [
                    {
                        "action": "gentle_start",
                        "description": "Comienza con la tarea más fácil de tu lista",
                        "duration": "15 minutos",
                    },
                    {
                        "action": "connect_with_why",
                        "description": "Recuerda por qué esta meta es importante para ti",
                        "duration": "10 minutos",
                    },
                    {
                        "action": "seek_support",
                        "description": "Contacta a tu red de apoyo si lo necesitas",
                        "duration": "Variable",
                    },
                ]
            )
