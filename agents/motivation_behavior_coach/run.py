"""
Punto de entrada para ejecutar el MotivationBehaviorCoach como un proceso independiente.
"""
...
async def main():
    """
    Función principal para ejecutar el MotivationBehaviorCoach.
    """
    try:
        ...
        # Ejecutar MotivationBehaviorCoach
        await run_agent(
        ...
        logger.error(f"Error al ejecutar el MotivationBehaviorCoach: {e}")
        sys.exit(1)
