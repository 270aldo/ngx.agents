...
PROGRAM_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    "PRIME": {
        ...
        "keywords": [
            "executive", "entrepreneur", "leader", "manager", "ceo", "founder", 
            "high performer", "professional", "negocios", "business", "ejecutivo", 
            "empresario", "líder", "director", "gerente", "fundador", "alto rendimiento",
            "executive performance", "rendimiento ejecutivo", "cognitive optimization", 
            "optimizacion cognitiva", "resilience", "resiliencia", "biohacking", 
            "peak performance", "leadership", "liderazgo", "decision making", 
            "toma decisiones", "stress management", "manejo estres", "focus", 
            "enfoque", "clarity", "claridad", "eficiencia", "efficiency", 
    ...
    "LONGEVITY": {
        ...
        "keywords": [
            "longevity", "longevidad", "aging", "envejecimiento", "senior", 
            "elderly", "adulto mayor", "tercera edad", "retirement", "jubilación",
            "functional independence", "independencia funcional", "cognitive health",
            "salud cognitiva", "muscle health", "salud muscular", "bone health",
            "salud ósea", "mobility", "movilidad", "balance", "equilibrio",
            "fall prevention", "prevención de caídas", "vitality", "vitalidad",
            "quality of life", "calidad de vida", "healthy aging", "envejecimiento saludable"
        ]
    },
    "STRENGTH": {
        "name": "STRENGTH",
        ...
        "keywords": [
            "fuerza", "strength", "powerlifting", "strongman", "power", "potencia",
            "levantamiento", "lifting", "carga", "load", "peso", "weight"
        ]
    },
    "HYPERTROPHY": {
        "name": "HYPERTROPHY",
        ...
        "keywords": [
            "hipertrofia", "hypertrophy", "muscle", "músculo", "bodybuilding", 
            "fisicoculturismo", "masa muscular", "muscle mass", "volumen", "volume",
            "estética", "aesthetics", "composición corporal", "body composition"
        ]
    },
    "ENDURANCE": {
        "name": "ENDURANCE",
        ...
        "keywords": [
            "resistencia", "endurance", "cardio", "cardiovascular", "aeróbico", 
            "aerobic", "maratón", "marathon", "triatlón", "triathlon", "running",
            "cycling", "ciclismo", "natación", "swimming", "ultra"
        ]
    },
    "ATHLETIC": {
        "name": "ATHLETIC",
        ...
        "keywords": [
            "atlético", "athletic", "deporte", "sport", "competitivo", "competitive",
            "performance", "rendimiento", "habilidad", "skill", "agilidad", "agility",
            "velocidad", "speed", "potencia", "power", "específico", "specific"
        ]
    },
    "PERFORMANCE": {
        "name": "PERFORMANCE",
        ...
        "keywords": [
            "rendimiento", "performance", "general", "balanced", "equilibrado",
            "fitness", "condición física", "physical condition", "integral",
            "comprehensive", "versatilidad", "versatility"
        ]
    }
}
