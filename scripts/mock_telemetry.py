...
class MockTelemetry:
    ...
    def record_event(self, category: str, name: str, attributes: Dict[str, Any] = None) -> None:
    ...
    def record_error(self, category: str, name: str, attributes: Dict[str, Any] = None) -> None:
