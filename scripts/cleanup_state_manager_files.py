...
# -*- coding: utf-8 -*-
"""
Script para limpiar archivos redundantes después de la migración del State Manager.

Este script identifica y elimina archivos redundantes o desactualizados relacionados
con la implementación anterior del State Manager, después de confirmar que la
...
REDUNDANT_FILES = [
    # Archivos de State Manager antiguos o temporales
    "core/state_manager.py",
    "core/state_manager_old.py",
    "core/state_manager_backup.py",
    "core/state_manager_temp.py",
    
    # Archivos de adaptador antiguos o temporales
    "infrastructure/adapters/state_manager_adapter_old.py",
    "infrastructure/adapters/state_manager_adapter_backup.py",
    "infrastructure/adapters/state_manager_adapter_temp.py",
    
    # Scripts de prueba temporales o antiguos
    "scripts/test_state_manager_old.py",
    "scripts/test_state_manager_temp.py",
    
    # Archivos de mock temporales
    "tests/mocks/core/state_manager_old.py",
    "tests/mocks/core/state_manager_temp.py",
]

# Directorio para backup
BACKUP_DIR = "backups/state_manager_cleanup"
...
def main():
    """Función principal."""
    parser = argparse.ArgumentParser(description="Limpiar archivos redundantes después de la migración del State Manager")
