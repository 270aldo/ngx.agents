...
# -*- coding: utf-8 -*-
"""
Script para limpiar archivos redundantes después de la migración del Intent Analyzer.

Este script identifica y elimina archivos redundantes o desactualizados relacionados
con la implementación anterior del Intent Analyzer, después de confirmar que la
...
REDUNDANT_FILES = [
    # Archivos de Intent Analyzer antiguos o temporales
    "core/intent_analyzer_old.py",
    "core/intent_analyzer_backup.py",
    "core/intent_analyzer_temp.py",
    
    # Archivos de adaptador antiguos o temporales
    "infrastructure/adapters/intent_analyzer_adapter_old.py",
    "infrastructure/adapters/intent_analyzer_adapter_backup.py",
    "infrastructure/adapters/intent_analyzer_adapter_temp.py",
    
    # Scripts de prueba temporales o antiguos
    "scripts/test_intent_analyzer_old.py",
    "scripts/test_intent_analyzer_temp.py",
    
    # Archivos de mock temporales
    "tests/mocks/core/intent_analyzer_old.py",
    "tests/mocks/core/intent_analyzer_temp.py",
]

# Directorio para backup
BACKUP_DIR = "backups/intent_analyzer_cleanup"
...
def main():
    """Función principal."""
    parser = argparse.ArgumentParser(description="Limpiar archivos redundantes después de la migración del Intent Analyzer")
    ...
    for file in non_existing_files:
        print(f"  - {os.path.join(base_dir, os.path.relpath(file, base_dir))}")
